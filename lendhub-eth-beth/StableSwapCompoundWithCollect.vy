...
contract HandleLendPlatformToken:
    def sell_lending_platform_token(isCoin1: bool, _value: uint256) -> uint256: modifying
...
def collect_lend_token():
    ...
    is_coin1: bool = xp[0] < xp[1]
    minted: uint256 = HandleLendPlatformToken(self.handle_lend_contract_address).sell_lending_platform_token(is_coin1, lend_token_balance)
    if is_coin1:
