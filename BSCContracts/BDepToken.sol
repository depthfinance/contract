...
contract BDepToken is ERC20, AccessControl {
    ...
    external
    {
        ...
        require(signatory != address(0), "BDepToken::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "BDepToken::delegateBySig: invalid nonce");
        require(now <= expiry, "BDepToken::delegateBySig: signature expired");
    ...
    returns (uint256)
    {
        require(blockNumber < block.number, "BDepToken::getPriorVotes: not yet determined");
    ...
    internal
    {
        ...
        // balance of underlying BDepTokens (not scaled);
    ...
    internal
    {
        uint32 blockNumber = safe32(block.number, "BDepToken::_writeCheckpoint: block number exceeds 32 bits");
